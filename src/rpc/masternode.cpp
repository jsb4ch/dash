...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Kash address\n"
            "  payee          - Print the masternode payout Kash address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Kash address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kash",               "masternode",             &masternode,             true,  {} },
    { "kash",               "masternodelist",         &masternodelist,         true,  {} },
    { "kash",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "kash",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
