    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  kash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Kash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 KASH, 0.01 KASH, 0.1 KASH, 1 KASH and 10 KASH -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.kashcore.org/en/stable/wallets/kashcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
