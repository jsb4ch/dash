...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Kash для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Kash для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ KASH&lt;/b&gt;!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа Kash Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Kash</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и kash: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Kash Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами Kash, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами Kash</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть kash: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью Kash</numerusform><numerusform>%n активных соединения с сетью Kash</numerusform><numerusform>%n активных соединений с сетью Kash</numerusform><numerusform>%n активных соединений с сетью Kash</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом Kash.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков Kash.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью Kash, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных Kash</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Kash Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Kash через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Kash через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Kash после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 KASH / 0 раундов</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик kash: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес Kash либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Kash (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Kash.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Kash.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Kash</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Kash для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше Kash, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К kash: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть Kash.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать Kash на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Kash address to sign the message with</source>
        <translation>Адрес Kash, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом Kash</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Kash, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Kash address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Kash</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>InstantSend пока что не поддерживает такие большие суммы. На данный момент транзакции ограничены суммами до %1 KASH.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к Kash (Мастерноды, PrivateSend, InstantSend, Governance) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вы запускаете кошелек в облегченном режиме, все специфичные для Kash функции отключены.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Держать N KASH анонимизированными (%u-%u, по умолчанию: %u)</translation>
    </message>
    <message>
