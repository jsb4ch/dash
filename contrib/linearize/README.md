# Linearize
Construct a linear, no-fork, best version of the Kash blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install kash_hash

https://github.com/kashpay/kash_hash
...
JSON-RPC server. Running `kashd` or `kash-qt -server` will be sufficient.
...
* `input`: kashd blocks/ directory containing blkNNNNN.dat
