...
space *do not upload these to the kash.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the kash.org server

- Update kash.org

- Announce the release:

  - Release on Kash forum: https://www.kash.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Kashpay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~kash.org/+archive/ubuntu/kash)
