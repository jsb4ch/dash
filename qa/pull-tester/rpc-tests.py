...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs kash_hash to pass
    'wallet-hd.py',
    'walletbackup.py',
    # vv Tests less than 5m vv
    'p2p-fullblocktest.py', # NOTE: needs kash_hash to pass
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs kash_hash to pass
    'llmq-chainlocks.py', # NOTE: needs kash_hash to pass
    'llmq-simplepose.py', # NOTE: needs kash_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs kash_hash to pass
    'llmq-is-retroactive.py', # NOTE: needs kash_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs kash_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs kash_hash to pass
    # vv Tests less than 60s vv
    'sendheaders.py', # NOTE: needs kash_hash to pass
    'zapwallettxes.py',
    'importmulti.py',
    'mempool_limit.py',
    'merkle_blocks.py',
    ...
    'invalidblockrequest.py', # NOTE: needs kash_hash to pass
    'invalidtxrequest.py', # NOTE: needs kash_hash to pass
...
ZMQ_SCRIPTS = [
    # ZMQ test can only be run if Kash Core was built with zmq-enabled.
...
EXTENDED_SCRIPTS = [
    ...
    # vv Tests less than 30s vv
    'bip65-cltv.py',
    'bip65-cltv-p2p.py', # NOTE: needs kash_hash to pass
    'bipdersig-p2p.py', # NOTE: needs kash_hash to pass
    'bipdersig.py',
    ...
    'p2p-acceptblock.py', # NOTE: needs kash_hash to pass
]
...
def run_tests(test_list, src_dir, build_dir, exeext, jobs=1, enable_coverage=False, args=[]):
    ...
    if "BITCOIND" not in os.environ:
        os.environ["BITCOIND"] = build_dir + '/src/kashd' + exeext
