...
from test_framework.test_framework import KashTestFramework
...
class LLMQCoinbaseCommitmentsTest(KashTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as KashTestFramework doesn't support this atm)
